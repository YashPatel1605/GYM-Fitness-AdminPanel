...
export const metadata: Metadata = {
  title: "Next.js Buttons | Gym-fitness - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Gym-fitness - Next.js Tailwind CSS Admin Dashboard Template",
};
