...
export const metadata: Metadata = {
  title: "Next.js Avatars | Gym-fitness - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Gym-fitness - Next.js Tailwind CSS Admin Dashboard Template",
};
